pantherProcessor = function(S_pwayID) {
	pathwayProcessor.call(this, S_pwayID);
	Ldebug('pantherProcessor called');
...
pantherProcessor.prototype = new pathwayProcessor();
pantherProcessor.prototype.constructor = pantherProcessor;
